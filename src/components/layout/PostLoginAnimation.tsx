...
export default function PostLoginAnimation({ onAnimationComplete }: { onAnimationComplete: () => void }) {
  ...
  return (
    ...
    <div className="fixed-top vw-100 vh-100 d-flex flex-column align-items-center justify-content-center bg-light" style={{ zIndex: 1050 }}>
       {/* Replace SVG with Bootstrap spinner or keep SVG if preferred */}
        <div className="spinner-border text-primary mb-3" role="status" style={{ width: '3rem', height: '3rem' }}>
            <span className="visually-hidden">Loading...</span>
        </div>
        {/* Original SVG - uncomment if preferred over Bootstrap spinner */}
        {/* <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary mb-3 animate-pulse">
      ...
      <p className="text-muted fs-5">Carregando seu painel...</p>
    </div>
  );
}
