  ...
  return (
    ...
    <div className="sticky top-0 z-40 bg-background/95 backdrop-blur-sm py-5 md:py-3 custom-sticky-search-shadow">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="custom-explore-search-bar-width-control border-0 flex justify-center items-center w-[94%] mx-auto bg-gradient-to-b from-[#e0dfdd] to-[#ffffff] rounded-full h-14 px-3 group focus-within:shadow-lg transition-shadow">
